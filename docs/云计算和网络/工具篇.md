...
[ubuntu2004安装](https://xie.infoq.cn/article/af423568b655968a605ed7fac)

## 开启嵌套虚拟化

1. [hyper v开启](https://www.fcwys.cc/archives/478.html)
2. virtualbox 开启
...
# 修改方法
virt-customize -a Fedora-Cloud-Base-33-1.2.x86_64.qcow2 --root-password password:yaowen
